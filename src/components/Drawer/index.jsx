    ...
    <div className="overlay">
      <div className={styles.drawer}>
        <h2 className="d-flex justify-between mb-30">
          Cart <img className="cu-p" src="./react-sneakers/img/btn-remove.svg" alt="Remove" onClick={onClose} />
        </h2>
        {items.length > 0 ? (
          <div>
                ...
                .map((product) => {
                  return (
                    <div className="cartItem d-flex align-center mb-20" key={product.id}>
                      ...
                      <img className="removeBtn" src="./react-sneakers/img/btn-remove.svg" alt="Remove" onClick={() => onRemove(product)} />
                    </div>
                  );
                })}
            </div>
            ...
            <div className="cartTotalBlock">
              ...
              <button className="greenButton">
                Buy <img src="./react-sneakers/img/arrow.svg" alt="Arrow" />
              </button>
            </div>
          </div>
        ) : (
          <div className="d-flex align-center justify-center flex-column flex">
            <img src="./react-sneakers/img/emptyCart.svg" alt="Empty cart" />
